...
\subsection{What is intrinsic dimensionality}

Here we provide some intuition about dimension of manifold

\subsection{Persistent dimensionality estimation}

Persistent dimensionality was studied in \cite{adams2020fractal, birdal2021intrinsic, jaquette2020fractal, schweinhart2021persistent}. Basic ideas can be traced back to combinatorial literature \cite{steele1988growth}. 
